...
module('Network.PB.S2CTalkBlackQueryResult')
...
local TALKBLACKQUERYRESULT = protobuf.Descriptor();
_M.TALKBLACKQUERYRESULT = TALKBLACKQUERYRESULT

__PBTABLE__.TALKBLACKQUERYRESULT_ID_FIELD = protobuf.FieldDescriptor();
__PBTABLE__.TALKBLACKQUERYRESULT_HEAD_FIELD = protobuf.FieldDescriptor();
__PBTABLE__.TALKBLACKQUERYRESULT_BLACKITEM_FIELD = protobuf.FieldDescriptor();
...
TALKBLACKPLAYERITEM.fields = {__PBTABLE__.TALKBLACKPLAYERITEM_PLAYERUID_FIELD, __PBTABLE__.TALKBLACKPLAYERITEM_HEADID_FIELD, __PBTABLE__.TALKBLACKPLAYERITEM_HEADCOLOR_FIELD, __PBTABLE__.TALKBLACKPLAYERITEM_PLAYERLEVEL_FIELD, __PBTABLE__.TALKBLACKPLAYERITEM_PLAYERNAME_FIELD}
TALKBLACKPLAYERITEM.is_extendable = false
TALKBLACKPLAYERITEM.extensions = {}
__PBTABLE__.TALKBLACKQUERYRESULT_ID_FIELD.name = "id"
__PBTABLE__.TALKBLACKQUERYRESULT_ID_FIELD.full_name = ".PB.TalkBlackQueryResult.id"
__PBTABLE__.TALKBLACKQUERYRESULT_ID_FIELD.number = 1
__PBTABLE__.TALKBLACKQUERYRESULT_ID_FIELD.index = 0
__PBTABLE__.TALKBLACKQUERYRESULT_ID_FIELD.label = 1
__PBTABLE__.TALKBLACKQUERYRESULT_ID_FIELD.has_default_value = true
__PBTABLE__.TALKBLACKQUERYRESULT_ID_FIELD.default_value = "SND_TALK_TALK_BLACK_QUERY_RESULT_MESSAGE"
__PBTABLE__.TALKBLACKQUERYRESULT_ID_FIELD.enum_type = PROTOCOLID or ProtocolId.PROTOCOLID
__PBTABLE__.TALKBLACKQUERYRESULT_ID_FIELD.type = 14
__PBTABLE__.TALKBLACKQUERYRESULT_ID_FIELD.cpp_type = 8

__PBTABLE__.TALKBLACKQUERYRESULT_HEAD_FIELD.name = "head"
__PBTABLE__.TALKBLACKQUERYRESULT_HEAD_FIELD.full_name = ".PB.TalkBlackQueryResult.head"
__PBTABLE__.TALKBLACKQUERYRESULT_HEAD_FIELD.number = 2
__PBTABLE__.TALKBLACKQUERYRESULT_HEAD_FIELD.index = 1
__PBTABLE__.TALKBLACKQUERYRESULT_HEAD_FIELD.label = 1
__PBTABLE__.TALKBLACKQUERYRESULT_HEAD_FIELD.has_default_value = false
__PBTABLE__.TALKBLACKQUERYRESULT_HEAD_FIELD.default_value = nil
__PBTABLE__.TALKBLACKQUERYRESULT_HEAD_FIELD.message_type = HEADMESSAGE or HeadMessage.HEADMESSAGE
__PBTABLE__.TALKBLACKQUERYRESULT_HEAD_FIELD.type = 11
__PBTABLE__.TALKBLACKQUERYRESULT_HEAD_FIELD.cpp_type = 10

__PBTABLE__.TALKBLACKQUERYRESULT_BLACKITEM_FIELD.name = "blackItem"
__PBTABLE__.TALKBLACKQUERYRESULT_BLACKITEM_FIELD.full_name = ".PB.TalkBlackQueryResult.blackItem"
__PBTABLE__.TALKBLACKQUERYRESULT_BLACKITEM_FIELD.number = 3
__PBTABLE__.TALKBLACKQUERYRESULT_BLACKITEM_FIELD.index = 2
__PBTABLE__.TALKBLACKQUERYRESULT_BLACKITEM_FIELD.label = 3
__PBTABLE__.TALKBLACKQUERYRESULT_BLACKITEM_FIELD.has_default_value = false
__PBTABLE__.TALKBLACKQUERYRESULT_BLACKITEM_FIELD.default_value = {}
__PBTABLE__.TALKBLACKQUERYRESULT_BLACKITEM_FIELD.message_type = TALKBLACKPLAYERITEM or TalkBlackPlayerItem.TALKBLACKPLAYERITEM
__PBTABLE__.TALKBLACKQUERYRESULT_BLACKITEM_FIELD.type = 11
__PBTABLE__.TALKBLACKQUERYRESULT_BLACKITEM_FIELD.cpp_type = 10

TALKBLACKQUERYRESULT.name = "TalkBlackQueryResult"
TALKBLACKQUERYRESULT.full_name = ".PB.TalkBlackQueryResult"
TALKBLACKQUERYRESULT.nested_types = {}
TALKBLACKQUERYRESULT.enum_types = {}
TALKBLACKQUERYRESULT.fields = {__PBTABLE__.TALKBLACKQUERYRESULT_ID_FIELD, __PBTABLE__.TALKBLACKQUERYRESULT_HEAD_FIELD, __PBTABLE__.TALKBLACKQUERYRESULT_BLACKITEM_FIELD}
TALKBLACKQUERYRESULT.is_extendable = false
TALKBLACKQUERYRESULT.extensions = {}

TalkBlackPlayerItem = protobuf.Message(TALKBLACKPLAYERITEM)
TalkBlackQueryResult = protobuf.Message(TALKBLACKQUERYRESULT)
