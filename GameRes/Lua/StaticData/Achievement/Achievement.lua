...
function BigLibraryData:Ctor(id)
    local BigLibraryMgr = Data.Achievement.Manager.Instance()
    ...
    local BigLibraryInfoMgr=Data.AchievementInfo.Manager.Instance()
...
function BigLibraryDataMgr:GetKeys()
    return Data.Achievement.Manager.Instance():GetKeys()
end
