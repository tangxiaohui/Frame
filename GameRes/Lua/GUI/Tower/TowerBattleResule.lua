...
local function InitControls(self)
    ...
    -- 胜利结果节点 --
    local BattleResultWinNodeClass = require "GUI.Tower.TowerBattleResultWinNode"
    self.battleResultWinNode = BattleResultWinNodeClass.New(transform:Find("TowerResultWin"))
    ...
    local pos = self.confirmButton.gameObject.transform.localPosition
    pos.x = 0
    self.confirmButton.gameObject.transform.localPosition = pos
end
