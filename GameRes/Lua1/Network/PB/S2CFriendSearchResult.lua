...
module('Network.PB.S2CFriendSearchResult')
...
local FRIENDSEARCHRESULT = protobuf.Descriptor();
_M.FRIENDSEARCHRESULT = FRIENDSEARCHRESULT

__PBTABLE__.FRIENDSEARCHRESULT_ID_FIELD = protobuf.FieldDescriptor();
__PBTABLE__.FRIENDSEARCHRESULT_HEAD_FIELD = protobuf.FieldDescriptor();
__PBTABLE__.FRIENDSEARCHRESULT_FRIEDS_FIELD = protobuf.FieldDescriptor();
...
__PBTABLE__.FRIENDSEARCHRESULT_ID_FIELD.name = "id"
__PBTABLE__.FRIENDSEARCHRESULT_ID_FIELD.full_name = ".PB.FriendSearchResult.id"
__PBTABLE__.FRIENDSEARCHRESULT_ID_FIELD.number = 1
__PBTABLE__.FRIENDSEARCHRESULT_ID_FIELD.index = 0
__PBTABLE__.FRIENDSEARCHRESULT_ID_FIELD.label = 1
__PBTABLE__.FRIENDSEARCHRESULT_ID_FIELD.has_default_value = true
__PBTABLE__.FRIENDSEARCHRESULT_ID_FIELD.default_value = "SND_TALK_FRIENDS_SEARCH_QUERY_RESULT_MESSAGE"
__PBTABLE__.FRIENDSEARCHRESULT_ID_FIELD.enum_type = PROTOCOLID or ProtocolId.PROTOCOLID
__PBTABLE__.FRIENDSEARCHRESULT_ID_FIELD.type = 14
__PBTABLE__.FRIENDSEARCHRESULT_ID_FIELD.cpp_type = 8

__PBTABLE__.FRIENDSEARCHRESULT_HEAD_FIELD.name = "head"
__PBTABLE__.FRIENDSEARCHRESULT_HEAD_FIELD.full_name = ".PB.FriendSearchResult.head"
__PBTABLE__.FRIENDSEARCHRESULT_HEAD_FIELD.number = 2
__PBTABLE__.FRIENDSEARCHRESULT_HEAD_FIELD.index = 1
__PBTABLE__.FRIENDSEARCHRESULT_HEAD_FIELD.label = 1
__PBTABLE__.FRIENDSEARCHRESULT_HEAD_FIELD.has_default_value = false
__PBTABLE__.FRIENDSEARCHRESULT_HEAD_FIELD.default_value = nil
__PBTABLE__.FRIENDSEARCHRESULT_HEAD_FIELD.message_type = HEADMESSAGE or HeadMessage.HEADMESSAGE
__PBTABLE__.FRIENDSEARCHRESULT_HEAD_FIELD.type = 11
__PBTABLE__.FRIENDSEARCHRESULT_HEAD_FIELD.cpp_type = 10

__PBTABLE__.FRIENDSEARCHRESULT_FRIEDS_FIELD.name = "frieds"
__PBTABLE__.FRIENDSEARCHRESULT_FRIEDS_FIELD.full_name = ".PB.FriendSearchResult.frieds"
__PBTABLE__.FRIENDSEARCHRESULT_FRIEDS_FIELD.number = 3
__PBTABLE__.FRIENDSEARCHRESULT_FRIEDS_FIELD.index = 2
__PBTABLE__.FRIENDSEARCHRESULT_FRIEDS_FIELD.label = 1
__PBTABLE__.FRIENDSEARCHRESULT_FRIEDS_FIELD.has_default_value = false
__PBTABLE__.FRIENDSEARCHRESULT_FRIEDS_FIELD.default_value = nil
__PBTABLE__.FRIENDSEARCHRESULT_FRIEDS_FIELD.message_type = TALKBLACKPLAYERITEM or TalkBlackPlayerItem.TALKBLACKPLAYERITEM
__PBTABLE__.FRIENDSEARCHRESULT_FRIEDS_FIELD.type = 11
__PBTABLE__.FRIENDSEARCHRESULT_FRIEDS_FIELD.cpp_type = 10

FRIENDSEARCHRESULT.name = "FriendSearchResult"
FRIENDSEARCHRESULT.full_name = ".PB.FriendSearchResult"
FRIENDSEARCHRESULT.nested_types = {}
FRIENDSEARCHRESULT.enum_types = {}
FRIENDSEARCHRESULT.fields = {__PBTABLE__.FRIENDSEARCHRESULT_ID_FIELD, __PBTABLE__.FRIENDSEARCHRESULT_HEAD_FIELD, __PBTABLE__.FRIENDSEARCHRESULT_FRIEDS_FIELD}
FRIENDSEARCHRESULT.is_extendable = false
FRIENDSEARCHRESULT.extensions = {}

FriendSearchResult = protobuf.Message(FRIENDSEARCHRESULT)
